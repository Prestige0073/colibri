            ...
            @else
                ...
                @if($delivered->isNotEmpty())
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#archivedOrdersModal">
                ...
                @if($active->isEmpty())
                    <div class="alert alert-info">
                        ...
                        @if($delivered->isNotEmpty())
                            <button type="button" class="btn btn-sm btn-outline-info ms-2" data-bs-toggle="modal" data-bs-target="#archivedOrdersModal">
                                ...
                                <div class="card shadow-sm rounded-4">
                                    <div class="card-body d-flex flex-column flex-md-row justify-content-between gap-3 align-items-start">
                                        <div class="d-flex align-items-start gap-3 flex-grow-1">
                                            <div class="icon-circle bg-light border rounded-circle d-flex align-items-center justify-content-center" style="width:56px;height:56px;min-width:56px;">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <div class="text-muted small mb-2">
                                                    <i class="fa {{ $addressIcon }} me-1"></i>{{ $c->adresse ?? 'Adresse non renseignée' }}
                                                </div>
                                                <div class="mb-2">
                                                ...
                                                <div class="small">
                                                    ...
                                                    @foreach($c->items as $it)
                                                        <div class="text-muted"><i class="fa fa-book text-secondary me-1"></i>{{ \Illuminate\Support\Str::limit($it->titre ?? 'Article', 60) }} <span class="text-dark">×{{ $it->quantite }}</span></div>
                                                    @endforeach
                                                </div>
                                            </div>
                                        </div>

                                        <div class="text-end d-flex flex-column align-items-end justify-content-between gap-2">
                                            <div>
                                                <a href="{{ route('commandes.show', $c->id) }}" class="btn btn-sm btn-outline-success">
                                            ...
                                            <div class="d-flex gap-2 flex-wrap">
                                                ...
                                                @endphp
                                                <a href="https://wa.me/{{ $phone }}?text={{ urlencode('Bonjour, je souhaite des informations sur ma commande #' . $c->id) }}" target="_blank" class="btn btn-success btn-sm">
                                                    <i class="fab fa-whatsapp me-1"></i><span class="d-none d-md-inline">WhatsApp</span>
                                                </a>
                                                <a href="mailto:{{ $email }}?subject={{ urlencode('Commande #' . $c->id) }}" class="btn btn-outline-secondary btn-sm">
                                                    <i class="fa fa-envelope me-1"></i><span class="d-none d-md-inline">Email</span>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
...
@if($delivered->isNotEmpty())
<div class="modal fade" id="archivedOrdersModal" tabindex="-1" aria-labelledby="archivedOrdersLabel" aria-hidden="true">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center pt-2 border-top">
                                        <strong class="text-success fs-5">
                                            ...
                                            {{ number_format($d->total, 0, ',', ' ') }} FCFA
                                        </strong>
                                        <a href="{{ route('commandes.show', $d->id) }}" class="btn btn-sm btn-outline-success">
