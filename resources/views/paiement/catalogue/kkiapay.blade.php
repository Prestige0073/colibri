                ...
                <div class="card shadow-sm mb-4">
                    <div class="card-header bg-primary text-white">
                        <div class="d-flex align-items-center justify-content-between">
                            <h5 class="mb-0">
                                <i class="fa fa-shopping-cart me-2"></i>Paiement de votre commande
                            </h5>
                            <a href="{{ route('panier.index') }}" class="btn btn-sm btn-outline-light">
                ...
                <div class="card shadow-lg border-0">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="bg-light rounded p-4 mb-4">
                            <h6 class="mb-3">Récapitulatif de votre commande</h6>
                            ...
                            @if($commande->items && $commande->items->count() > 0)
                                @foreach($commande->items as $item)
                                    <div class="d-flex justify-content-between mb-2">
                                        ...
                                        <strong>{{ fcfa($item->prix * $item->quantite) }}</strong>
                                    </div>
                                @endforeach
                            @else
                                <div class="d-flex justify-content-between mb-2">
                                    <span class="text-muted">Articles de votre commande</span>
                                    <strong>Voir détails dans votre compte</strong>
                                </div>
                            @endif
...
<script>
    ...
    addKkiapayListener('success', function(response) {
        ...
        setTimeout(function() {
            window.location.href = "{{ route('paiement.catalogue.kkiapay.callback') }}" +
