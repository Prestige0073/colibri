...
@section('title', 'Paiement TEST - Formation')
            ...
            <div class="card shadow-lg border-warning border-3">
                ...
                <div class="card-body p-4">
                    ...
                    <h4 class="text-success mb-4">
                        <i class="fa fa-graduation-cap me-2"></i>{{ $formation->titre }}
                    </h4>
                        ...
                        <div class="bg-light p-3 rounded">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <span class="text-success fs-5">{{ number_format($montant, 0, ',', ' ') }} FCFA</span>
                                </div>
                                <div class="col-12 mt-2">
                                    <strong>Description:</strong><br>
                                    {{ Str::limit($formation->description, 200) }}
                                </div>
                            </div>
                        </div>
                    </div>

                    <form method="POST" action="{{ route('paiement.test.formation.validate', $inscription->id) }}" id="testPaymentForm">
                        @csrf
                        ...
                        <div class="alert alert-warning border-warning">
                            ...
                            <ul class="mb-0">
                                <li>Valider instantanément l'inscription</li>
                                <li>Accéder immédiatement à la formation</li>
                                <li>Recevoir un email de confirmation</li>
                                <li>Obtenir une référence de paiement TEST</li>
                            </ul>
                        </div>
                        ...
                        <div class="bg-light p-4 rounded mb-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" value="TEST-XXXXXXXX (générée automatiquement)" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-grid gap-3">
                            <button type="submit" class="btn btn-warning btn-lg py-3">
                                ...
                                <strong>SIMULER LE PAIEMENT</strong>
                            </button>

                            <a href="{{ route('formation.show', $formation->id) }}" class="btn btn-outline-secondary">
