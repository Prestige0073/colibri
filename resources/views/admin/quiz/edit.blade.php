...
<div class="container-fluid">
    <div class="mb-4">
        <h1><i class="fas fa-edit me-2"></i>Modifier le Quiz</h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('admin.quizzes.index') }}">Quiz</a></li>
                <li class="breadcrumb-item"><a href="{{ route('admin.quizzes.show', $quiz->id) }}">{{ $quiz->titre }}</a></li>
    ...
    <form action="{{ route('admin.quizzes.update', $quiz->id) }}" method="POST" class="needs-validation-confirm">
        @csrf
        @method('PUT')
                    ...
                    <div class="col-md-8">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('titre') is-invalid @enderror"
                                   id="titre" name="titre" value="{{ old('titre', $quiz->titre) }}" data-important="true">
                            @error('titre')
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('duree_minutes') is-invalid @enderror"
                                   id="duree_minutes" name="duree_minutes" value="{{ old('duree_minutes', $quiz->duree_minutes) }}" min="1">
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('note_passage') is-invalid @enderror"
                                   id="note_passage" name="note_passage" value="{{ old('note_passage', $quiz->note_passage) }}" min="0" max="100" data-important="true">
                            @error('note_passage')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('nombre_tentatives') is-invalid @enderror"
                                   id="nombre_tentatives" name="nombre_tentatives" value="{{ old('nombre_tentatives', $quiz->nombre_tentatives) }}" min="1" max="10" data-important="true">
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="active" name="active" value="1" {{ old('active', $quiz->active) ? 'checked' : '' }}>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="afficher_reponses" name="afficher_reponses" value="1" {{ old('afficher_reponses', $quiz->afficher_reponses) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-4">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="melanger_questions" name="melanger_questions" value="1" {{ old('melanger_questions', $quiz->melanger_questions) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-4">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="melanger_options" name="melanger_options" value="1" {{ old('melanger_options', $quiz->melanger_options) ? 'checked' : '' }}>
        ...
        <div class="d-flex justify-content-between">
            <a href="{{ route('admin.quizzes.show', $quiz->id) }}" class="btn btn-secondary">
