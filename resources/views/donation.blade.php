...
@section('title', 'Faire un don | Colibri Littéraire - Soutenir la culture et le livre africain')
@section('meta_description', "Soutenez Colibri Littéraire et la culture africaine par vos dons. Financement de projets, formations et publications pour le livre africain.")
@section('meta_keywords', 'don, soutien, livre africain, culture, formation, édition, Colibri Littéraire, francophonie, projet, publication')

@section('content')
    <!-- Page Header Start -->
    <div class="container-fluid page-header py-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-4">
            <h1 class="display-3 animated slideInDown">Faire un don</h1>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeIn" data-wow-delay="0.1s" style="max-width: 500px;">
                ...
                <h1 class="display-6 mb-4">Soutenez nos actions pour le livre africain</h1>
            </div>
            <div class="row g-4">
                    ...
                    <div class="donation-item d-flex h-100 p-4">
                        ...
                        <div class="donation-detail">
                            <div class="position-relative mb-4">
                                ...
                                <a href="#!"
                                    class="btn btn-sm btn-secondary px-3 position-absolute top-0 end-0">Livre</a>
                            </div>
                ...
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                    <div class="donation-item d-flex h-100 p-4">
                        ...
                        <div class="donation-detail">
                            ...
                            <a href="#!" class="h3 d-inline-block">Soutien à la lecture</a>
                            <p>Through your donations and volunteer work, we spread kindness and support to children.
                            </p>
                            <a href="#!" class="btn btn-primary w-100 py-3"><i class="fa fa-plus me-2"></i>Donate
                                Now</a>
                    ...
                    <div class="donation-item d-flex h-100 p-4">
                        ...
                        <div class="donation-detail">
                            <div class="position-relative mb-4">
                                <img class="img-fluid w-100" src="{{ asset('img/donation-2.jpg') }}" alt="">
                                <a href="#!"
                                    class="btn btn-sm btn-secondary px-3 position-absolute top-0 end-0">Édition</a>
                            </div>
                            <a href="#!" class="h3 d-inline-block">Soutien à l’édition</a>
                            <p>Through your donations and volunteer work, we spread kindness and support to children.
                            </p>
                            <a href="#!" class="btn btn-primary w-100 py-3"><i class="fa fa-plus me-2"></i>Donate
                                Now</a>
                    ...
                    <div class="donation-item d-flex h-100 p-4">
                        ...
                        <div class="donation-detail">
                            <div class="position-relative mb-4">
                                <img class="img-fluid w-100" src="{{ asset('img/donation-3.jpg') }}" alt="">
                                <a href="#!"
                                    class="btn btn-sm btn-secondary px-3 position-absolute top-0 end-0">Formation</a>
                            </div>
                            <a href="#!" class="h3 d-inline-block">Soutien à la formation</a>
                            <p>Through your donations and volunteer work, we spread kindness and support to children.
                            </p>
                            <a href="#!" class="btn btn-primary w-100 py-3"><i class="fa fa-plus me-2"></i>Donate
                                Now</a>
